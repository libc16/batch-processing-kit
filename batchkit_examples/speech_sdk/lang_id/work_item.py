...
class LangIdWorkItemRequest(WorkItemRequest):
    def __init__(self, filepath: str, candidate_languages: List[str], max_segment_length: int,
                 lid_timeout: int, recognize_retry: int,
        ...
        :param lid_timeout: maximum duration to wait for language identification (LID) to complete for the audio file.
        :param recognize_retry: maximum number of retries for language identification (LID) to complete for the audio file.
